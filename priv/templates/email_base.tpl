...
<body width="100%" style="margin: 0; padding: 0 !important; mso-line-height-rule: exactly; background-color: {{ bgcolor }};">
    ...
    <![endif]-->
        ...
        <div style="display: none; font-size: 1px; line-height: 1px; max-height: 0px; max-width: 0px; opacity: 0; overflow: hidden; mso-hide: all; font-family: monospace;" aria-hidden="true">
        ...
        {% filter replace:'<h1>':'<h1 style="margin: 0 0 10px 0; font-family: monospace; font-size: 25px; line-height: 30px; color: #333333; font-weight: normal;">' %}
        {% filter replace:'<h2>':'<h2 style="margin: 0 0 10px 0; font-family: monospace; font-size: 20px; font-weight: normal;">' %}
        {% filter replace:'<h3>':'<h3 style="margin: 0 0 10px 0; font-family: monospace; font-size: 18px;">' %}
        {% filter replace:'<h4>':'<h4 style="margin: 0 0 10px 0; font-family: monospace; font-size: 16px; font-weight: bold;">' %}
            ...
            <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin: 20px auto;">
                ...
                <tr>
                    <td style="padding: 20px 0; text-align: center">
                        <img src="https://via.placeholder.com/200x50" width="200" height="50" alt="alt_text" border="0" style="height: auto; background: #dddddd; font-family: monospace; font-size: 15px; line-height: 15px; color: #555555;">
                        }
                    </td>
                </tr>
                <!-- Email Header : END -->
                ...
                <tr>
                    <td style="background-color: #ffffff;">
                        <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                            {% block content %}
                            <tr>
                                <td style="padding: 20px 20px 10px 20px; font-family: monospace; font-size: 15px; line-height: 20px; color: #555555;">
...
{% comment %}
                ...
                <tr>
                    <td style="background-color: #ffffff;">
                        <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                            <tr>
                                <td style="padding: 20px; font-family: monospace; font-size: 15px; line-height: 20px; color: #555555;">
...
{% endcomment %}
            ...
            <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin: auto;">
                <tr>
                    <td style="padding: 20px 20px 10px 20px; font-family: monospace; font-size: 14px; line-height: 15px; text-align: center; color: #ffffff;">
                        {% block footer %}
                            {% if id %}
                    ...
                    <tr>
                        <td>
                            <div align="center" style="max-width: 600px; margin: auto;" class="email-container">
                                ...
                                <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                                    <tr>
                                        <td style="padding: 20px; text-align: left; font-family: monospace; font-size: 15px; line-height: 20px; color: #ffffff;">
